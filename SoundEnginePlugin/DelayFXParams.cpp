...
AKRESULT DelayFXParams::Init(AK::IAkPluginMemAlloc* in_pAllocator, const void* in_pParamsBlock,
...
AKRESULT DelayFXParams::SetParam(AkPluginParamID in_paramID, const void* in_pValue,
